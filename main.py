...
load_dotenv()
import os
# my_secret = os.environ['HUGGINFACE_TOKEN']
...
API_URL = 'https://api-inference.huggingface.co/models/Prarabdha/'
...
class MyClient(discord.Client):
    def __init__(self, model_name):
        ...
        huggingface_token = os.environ['HUGGINFACE_TOKEN']
    ...
    def query(self, payload):
        ...
        # data_text = data['text']
        response = requests.post(self.api_endpoint,                             headers=self.request_headers,
                                    data=data)
